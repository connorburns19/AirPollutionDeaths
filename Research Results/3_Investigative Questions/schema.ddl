...
CREATE TABLE PollutionDeathsByLocation (
	location TEXT NOT NULL,
    year INT NOT NULL,
    totalDeathsPer100K FLOAT NOT NULL,
    outdoorDeathsPer100K FLOAT NOT NULL,
    indoorDeathsPer100K FLOAT NOT NULL,
    ozoneDeathsPer100K FLOAT NOT NULL,
	PRIMARY KEY (location, year),
    FOREIGN KEY(location, year) REFERENCES Population(location, year),
    check (year >= 0),
...
---A tuple in this table represnts a row in the population sample data, with each collumn corresponding to a collumn in the csv file.
--- id and location correspond to the location, varID and variant represnt the population variant, year represnts the year, midPeriod
--- represnts the mean population inbetween that time period, males is the male population, female is the femal population, totalPopulation
--- is the total population and density is the population density.
...
---A row in this table represnts a row in the emissions sample data, with each collumn corresponding to a collumn in the csv file.
---entity and code represnts the entity, year represnts the year and annualEmissions represents the annualEmissions.
...
---A row in this table represnts a row in the pollution deaths sample data, with each collumn corresponding to a collumn in the csv file.
---entity and code represent the entity, year represents the year, airPollutionDeathsPer100K represents the number of airPollutionDeaths per 100 K population.
---indoor outdoor and ozone are all sub columns of that (they add up to airPollutionDeathsper100K).
